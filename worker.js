...
async function callGeminiMealComment(env, context) {
  ...
  const prompt = [
    ...
    "出力は日本語で、次の3項目だけにしてください。各項目は1〜3文で、理由を具体的に書いてください。",
    "良い点: 何が良いのか、どの食材・食べ方・量・タイミングが、血圧/尿酸値/LDL/HbA1c/体重/百歳まで動ける体づくりのどれにどう役立つのかを書く。",
    "改善点: 何が悪い、または惜しいのかを具体的に書く。塩分、糖質、脂質、たんぱく質不足、食物繊維不足、夜遅い食事、飲酒、サプリの重複や過量など、該当する理由を書く。",
    "次回の一手: 次に同じ場面で何を1つ変えればよいか、現実的な置き換えや追加を1つだけ書く。",
    "良い/悪いを断定しすぎず、食事ログから分かる範囲で説明してください。",
